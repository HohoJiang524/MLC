...
python3 ./ESKDB/ClassifierChain_ESKDB_bayesNet.py $dataset nominal

echo BayesianClassifierChain_ESKDB_bayesNet
python3 ./ESKDB/BayesianClassifierChain_ESKDB_bayesNet.py $dataset nominal

echo LEAD_ESKDB
python3 ./ESKDB/LEAD_ESKDB_bayesNet.py $dataset nominal
